...
def is_mel(name, email):
    ...
    >>> is_mel('Michelle', 'michelle@gmail.com')
    False
    ...
    >>> is_mel('Yao Li', 'mel@ubermelon.com')
    True

    """

    return name.title() == "Mel Melitpolski" or email.lower() == "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{"type": "dessert"}, {"type": "dessert"}, {"type": "appetizer"}, {"type": "appetizer"}, {"type": "drinks"}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'drinks')
